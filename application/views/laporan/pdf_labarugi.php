...
class PDF extends FPDF
{
	...
	function Header()
	{
                ...
                $this->cell(100,6,'LAPORAN LABA RUGI',0,1,'C',1);
                
                
                $this->Ln(6);
                $this->cell(19,6,'',0,0,'C',0);
                $this->setFont('Arial','',10);
	...
	function Content($data,$total)
	{
            ...
            $no = 1;
                ...
                $this->Ln();
                $this->cell(19,6,'',0,0,'C',0); 
                $this->cell(90,5,'Total Bersih Setelah Potongan',1,0,'C',1);
                $this->cell(70,5,number_format($kredit-$debet, 0 ,'' , '.' ),1,0,'R',1);
	}
	function Footer()
	{
