...
<div id="content">
                            ...
                            <div class="col-md-12">
                                <div class="panel box-v4">
                                    <div class="panel-heading bg-white border-none">
                                      <h4><span class="fa fa-cart-arrow-down"></span> Data Pelanggan</h4>
                                    </div>
       ...
       <div> 
          <button type="button" class="btn btn-primary" 
                id="tambah">
                  <i class="icons icon-user-follow"></i> Tambah Pelanggan</button>
       </div>
<div class="panel-body">
        ...
        <tbody>
          ...
          <td><b><?php echo $key->nama_pelanggan;?></b></td>
          ...
          ?>
          <button class=" btn btn-circle btn-mn btn-danger" onclick="deletePelanggan(<?php echo $key->id_pelanggan  ?>)" value="primary">
                                <span class="fa fa-close"></span>
                              </button> Hapus  
                              <a href="#" class="oke btn btn-circle btn-mn btn-info" 
                              data-toggle="modal" data-target="#Modaledit"
                              data-id="<?php echo $key->id_pelanggan; ?>" 
                              data-nama="<?php echo $key->nama_pelanggan;?>"
                              data-alamat="<?php echo $key->alamat_pelanggan; ?>" 
                              data-tlpn="<?php echo $key->no_tlpn?>"
                              data-jarak="<?php echo $key->jarak?>" >
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4-x style="color:red;"><span class="glyphicon glyphicon-lock"></span> Data Pelanggan</h4-x>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label for="jarak"><span class="icons icon-location-pin"></span> Jarak Rumah</label>
              <input type="text" class="form-control" id="Ejarak_Pelanggan" name="Jarak_Pelanggan" placeholder="Enter 12">
            </div>
...
function deletePelanggan(id){
  ...
  $.post("<?= site_url('user/delPelanggan')?>", //Required URL of the page on server
 ...
 var jarak= $("#jarak_Pelanggan").val();
  ...
  $.post("<?= site_url('user/addPelanggan')?>", //Required URL of the page on server
            { // Data Sending With Request To Server
                nama:nama,
                alamat:alamat,
                no:no_tlpn,
...
function editPelanggan(){
  ...
  if (id == '' || id == 0) {
      ...
      $.post("<?= site_url('User/updatePelanggan')?>", //Required URL of the page on server
            { // Data Sending With Request To Server
                id:id,
                nama:nama,
                alamat:alamat,
